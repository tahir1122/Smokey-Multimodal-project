...
public class ConnectionManager : MonoBehaviour {
	...
	public static Connection FindConnection(Transform t1, Transform t2) {
	...
	public static List<Connection> FindConnections(Transform transform) {
	...
	public static void CreateConnection(Transform t1, Transform t2 = null) {
		if (!instance) return;
