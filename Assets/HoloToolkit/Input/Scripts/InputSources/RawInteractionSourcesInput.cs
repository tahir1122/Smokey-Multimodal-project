...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class RawInteractionSourcesInput : BaseInputSource
    {
        ...
        /// </summary>
        /// <param name="interactionSourceState">Interaction source to use to update the position.</param>
        ...
        private void UpdateSourceState(InteractionSourceState interactionSourceState, SourceData sourceData)
        {
            ...
            if (interactionSourceState.properties.location.TryGetPosition(out sourcePosition))
            {
            ...
            if (interactionSourceState.pressed != sourceData.IsSourceDownPending)
            {
                sourceData.IsSourceDownPending = interactionSourceState.pressed;
