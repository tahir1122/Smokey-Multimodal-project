...
namespace HoloToolkit.Unity
{
    ...
    public class StabilizationPlaneModifier : Singleton<StabilizationPlaneModifier>
    {
        ...
        private void ConfigureTransformOverridePlane(float deltaTime)
        {
            ...
            UnityEngine.VR.WSA.HolographicSettings.SetFocusPointForFrame(planePosition, -gazeManager.GazeNormal, velocity);
        }
        ...
        private void ConfigureFixedDistancePlane(float deltaTime)
        {
            ...
            UnityEngine.VR.WSA.HolographicSettings.SetFocusPointForFrame(planePosition, -gazeManager.GazeNormal, Vector3.zero);
        }
